...
# Draw plot
c.drawImage("revenue_per_car.png", plot_x, plot_y, width=plot_width, height=plot_height)
...
# Draw plot
c.drawImage("yoy_revenue_per_car.png", plot_x, plot_y, width=plot_width, height=plot_height)
